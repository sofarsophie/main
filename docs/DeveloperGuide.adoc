...
The `find` command was enhanced to allow a more rigorous search. The new find command allows users to search for Persons in the humanDEX using any fields.
